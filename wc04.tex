...
\begin{parts}
  ...
  \begin{solution}
    I: \textcolor{purple}{Replace this statement.}
    \[
      \begin{array}{ccc}
    \begin{array}{c|cc}
      & S(x) & P(x) \\\hline
  ...
  \begin{solution}
    O: \textcolor{purple}{Replace this statement.}
    \[
      \begin{array}{ccc}
    \begin{array}{c|cc}
      & S(x) & P(x) \\\hline
  ...
  \begin{solution}
    \[
      \begin{array}{c@{\;:\;}l}
        \text{A} & \forall x(S(x) \cp{?} P(x))\\[5pt]
        \text{E} & \forall x(S(x) \cp{?} \neg P(x))\\[5pt]
        \text{I} & \exists x(S(x) \cp{?} P(x))\\[5pt]
        \text{O} & \exists x(S(x) \cp{?} \neg P(x))
      \end{array}
    \]
  \end{solution}
  \part[3]
  ...
  \begin{minipage}[t]{.69\linewidth}
    ...
    Using your predicate logic expressions from the previous part, justify how A contradicts O, how E contradicts I, and vice versa. Provide precise derivations.
  \end{minipage}
